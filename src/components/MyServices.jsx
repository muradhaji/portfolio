            ...
            <div className='service service1'>
              ...
              <div className='text'>
                ...
                <p>
                  ...
                  new data from the web server, instead of loading entire new
            ...
            <div className='service service4'>
              <div className='text'>
                ...
                <p>
                  ...
                  Because search is one of the main ways in which people
            ...
            <div className='service service5'>
              ...
              <div className='text'>
                ...
                <p>
                  ...
                  output, speed, or scalability. It plays a key role in ensuring
                  that the available resources are put to the best use.
                </p>
              </div>
            </div>
          </div>
